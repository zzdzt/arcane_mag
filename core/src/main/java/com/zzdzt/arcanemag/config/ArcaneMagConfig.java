...
/**
 * ArcaneMag 模组配置（arcane_mag-server.toml）。
 *
 * 仅保留 core 通用配置：spell / upgrade / spell_classification / mod_charge。
 * [enchantment] section 已迁至 enchant 模块的 EnchantConfig（arcane_mag_enchant-server.toml）。
 */
