...
public class DryManaFrenzyEnchantment extends AbstractPerkEnchantment {
    ...
    public static float damageMultiplier(int level) {
        return 1.0f + (float) (level * ArcaneMagConfig.DRY_MANA_FRENZY_DAMAGE_PER_LEVEL.get());
    }
    ...
    public static float rpmMultiplier() {
        return 1.0f + ArcaneMagConfig.DRY_MANA_FRENZY_FIRE_RATE_BONUS.get().floatValue();
    }
}
