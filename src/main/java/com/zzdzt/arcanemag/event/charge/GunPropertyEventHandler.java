...
public class GunPropertyEventHandler {
    ...
    /** 效果移除时标记，下一 tick 强制刷新枪械缓存 */
    private static final Set<UUID> PENDING_REFRESH = new HashSet<>();
    /** 客户端独立的状态追踪（单人游戏时 client/server 共享 JVM 静态字段） */
    ...
    /**
     * 效果自然到期时标记刷新（此时效果仍在实体上，下一 tick 才真正移除）
     */
    @SubscribeEvent
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        // 选择对应侧的状态表（单人游戏时 client/server 共享 JVM，必须隔离）
